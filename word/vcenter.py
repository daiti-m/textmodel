...
def usage ():
    print ('usage: % centerize.py words.vec text.txt centered.vec')
    print ('$Id: centerize.py,v 1.3 2022/07/25 02:31:30 daichi Exp $')
    sys.exit (0)
...
def main ():
    ...
    newmatrix = centerize (matrix, words, unigram)
